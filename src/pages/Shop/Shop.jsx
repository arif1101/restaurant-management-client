        ...
        <div>
            ...
            <div className='mt-[100px] grid grid-cols-2 gap-y-8'>
                <div className='w-[570px] h-[130px] bg-[#F9FAFC] flex p-[30px] gap-11 items-center'>
                    <img className='w-[70px] h-[70px]' src="/src/assets/foodIcon/starters.png" alt="" />
                    <div>
                ...
                <div className='w-[570px] h-[130px] bg-[#F9FAFC] flex p-[30px] gap-11 items-center'>
                    <img className='w-[70px] h-[70px]' src="/src/assets/foodIcon/main.png" alt="" />
                    <div>
                ...
                <div className='w-[570px] h-[130px] bg-[#F9FAFC] flex p-[30px] gap-11 items-center'>
                    <img className='w-[70px] h-[70px]' src="/src/assets/foodIcon/drinks.png" alt="" />
                    <div>
                ...
                <div className='w-[570px] h-[130px] bg-[#F9FAFC] flex p-[30px] gap-11 items-center'>
                    <img className='w-[70px] h-[70px]' src="/src/assets/foodIcon/deserts.png" alt="" />
                    <div>
            ...
            <div className='mt-[100px] flex flex-col gap-[60px]'>
                ...
                <div className='flex justify-between'>
                    <div className='w-[270px] p-[30px] flex flex-col gap-5 bg-[#F9FAFC]'>
                        <img className='h-[270px]' src="/src/assets/chef/chef2-.jpg" alt="" />
                    ...
                    <div className='w-[270px] p-[30px] flex flex-col gap-5 bg-[#F9FAFC]'>
                        <img className='h-[270px]' src="/src/assets/chef/chef-3.jpg" alt="" />
                        <div className='flex flex-col items-center gap-5'>
                            <h1 className='text-xl font-bold'>Paul Trueman</h1>
                            <p className='font-semibold text-stone-400'>Chef</p>
                            <div className='flex gap-4 text-xl'>
                    ...
                    <div className='w-[270px] p-[30px] flex flex-col gap-5 bg-[#F9FAFC]'>
                        <img className='h-[270px]' src="/src/assets/chef/chef-4.jpg" alt="" />
                        <div className='flex flex-col items-center gap-5'>
                            <h1 className='text-xl font-bold'>Paul Trueman</h1>
                            <p className='font-semibold text-stone-400'>Chef</p>
                            <div className='flex gap-4 text-xl'>
                    ...
                    <div className='w-[270px] p-[30px] flex flex-col gap-5 bg-[#F9FAFC]'>
                        <img className='h-[270px]' src="/src/assets/chef/chef-5.jpg" alt="" />
                        <div className='flex flex-col items-center gap-5'>
                            <h1 className='text-xl font-bold'>Paul Trueman</h1>
                            <p className='font-semibold text-stone-400'>Chef</p>
                            <div className='flex gap-4 text-xl'>
